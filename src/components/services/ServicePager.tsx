...
const LABEL = "text-[11px] font-semibold tracking-[0.16em] text-clay uppercase";
const TITLE =
  "text-2xl leading-[1.08] font-normal tracking-[-0.025em] break-words text-ink uppercase transition-colors duration-500 group-hover:text-clay md:text-[2rem]";
