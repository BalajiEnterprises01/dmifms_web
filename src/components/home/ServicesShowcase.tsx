        ...
        <div className="col-span-12 flex flex-col lg:col-span-6 lg:pl-6">
          <div className="flex items-start justify-between gap-6">
            <AnimatePresence mode="wait">
              <motion.p
                ...
                className="pt-1 text-eyebrow font-semibold tracking-[0.16em] text-clay uppercase">
          ...
          <AnimatePresence mode="wait">
            <motion.div
              ...
              <h3 className="text-heading-sm leading-[0.98] font-normal tracking-[-0.035em] text-ink uppercase">
                {service.title}
              </h3>
              ...
              <p className="mt-10 max-w-lg text-body leading-[1.7] text-clay">{service.description}</p>
              <Link
