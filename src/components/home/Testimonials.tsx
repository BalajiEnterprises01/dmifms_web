        ...
        <Reveal className="col-span-12 flex flex-col justify-between gap-8 lg:col-span-5">
          <AnimatePresence mode="wait">
            <motion.p
              key={current.id}
              {...fade}
              className="flex flex-wrap items-baseline gap-x-6 gap-y-2 text-[14px] font-semibold tracking-[0.16em] uppercase">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="w-16 text-center text-eyebrow font-medium text-clay tabular-nums">
        ...
        <div className="col-span-12 lg:col-span-7">
          <AnimatePresence mode="wait">
            <motion.figure key={current.id} {...fade}>
              <blockquote className="text-statement leading-[1.18] tracking-[-0.025em] text-ink">
                “{current.quote}”
              </blockquote>
              <figcaption className="mt-8 grid max-w-md grid-cols-2 gap-6 border-t border-ink/10 pt-6">
                <div>
                  <p className="text-eyebrow font-semibold tracking-[0.16em] text-clay uppercase">Role</p>
                  <p className="mt-1.5 text-base text-ink">{current.author}</p>
                </div>
                <div>
                  <p className="text-eyebrow font-semibold tracking-[0.16em] text-clay uppercase">Organisation</p>
                  <p className="mt-1.5 text-base text-ink">{current.company}</p>
                </div>
              </figcaption>
            </motion.figure>
          </AnimatePresence>
